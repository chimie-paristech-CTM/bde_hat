...
parser.add_argument('--csv_file', type=str, default='../../data/reactivity_database_mapped.csv',
                    help='path to file containing reaction_profiles')
parser.add_argument('--pkl_file', type=str, default='../../data/species_reactivity_dataset_pred.pkl',
                    help='path to file containing output surrogate model')


def create_dataset_baseline_model_new(pkl_file, csv_file):
    ...
    input_ffnn['G_r'] = reactivity_data.G_r
    input_ffnn['DG_TS'] = reactivity_data.DG_TS
    #input_ffnn['DG_TS_tunn'] = reactivity_data.DG_TS_tunn
    ...
    input_ffnn.to_csv('../../data/input_ffnn.csv')
    input_ffnn.to_pickle('../../data/input_ffnn.pkl')
